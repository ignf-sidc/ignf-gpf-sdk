...
class DictResolverTestCase(GpfTestCase):
    ...
    def test_resolve(self) -> None:
        ...
        self.assertEqual(o_arc.exception.message, f"Erreur du résolveur '4t' avec la chaîne '{s_to_solve}' : la clef demandé ne se trouve pas dans le dictionnaire ({s_to_solve})")
